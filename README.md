...
## 2.2.超级节点
* 有1个超级节点，不能增删改，负责初始化系统，并生成创世区块，在完成区块链初始化后，仅保留钱包收入和支出权限；
...
## 3.2.融资发行
* 融资发行1,443,497,378.00元数字五民币代币，价格为每1.00元数字五民币0.01USDT，单次最少购买10,000.00元五民币，单次购买少于10,000.00元的不计入奖励资格，预计融资额14,434,973.78USDT（1443.49万USDT），由国储会权威节点发行；
   |           资金用途                       |     占比    |  预算金额（USDT）  |
   |:---------------------------------------:|:-----------:|:---------------:|
...
#### 6.1.2.3.权威证明/PoA
* 含超级节点、国储会权威节点、省储会权威节点，超级节点负责区块链初始化，国储会权威节点负责发行和销毁，省储会权威节点参与发行和销毁；
### 6.1.3.节点/nodes
...
#### 6.7.1.2.奖励发行合约/bonus_issue_smart
