...
* 链下交易上链的，除省储行权益节点获得的手续费外，其他链下交易不用再支付链上交易费，例：小李支付1000元五民币给小习，由广东省储行权益节点清算的，费率为0.1%，那么小习收到1000元，广东省储行权益节点收到1元，该交易上链时，那1000元不用支付链上交易费，而广东省储行获得的1元需要支付链上交易手续费。  
## 4.2.链下交易费
...
* 由任一省储行验证的链下交易在验证后将广播至全部省储行节点和权威节点。
### 6.1.3.节点/nodes
...
* 使用32字节公钥+主网ID（880711，4字节+2字节校验，采用SS58编码生成以wmb开头的钱包地址。
