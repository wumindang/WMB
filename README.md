...
* 国储会节点发起发行数字五民币、销毁数字五民币、增删改新省储会、增删改新省储行、部署公民轻节点发行智能合约流程的，需权威节点间投票（国储会、省储会）,且公民轻节点可投票驳回。
## 2.3.省储会权威节点  
...
## 4.1.链上交易费
* 链上交易费为0.1%，即千分之一；  
* 链上交易手续费的99%用于奖励铸块的全节点，1%支付给国储会权威节点交易钱包用于社区建设，链下交易和纸质五民币的交易手续费不适用于此条规则；  
* 由运营链下支付通道的节点上链结算链下交易的，除该节点所获得的收益需要支付链上交易手续费外，其余已经收取了链下交易手续费的那部分链下交易的金额，上链后将不再收取链上交易手续费。  
## 4.2.链下交易费
* 链下交易手续费由开通运营链下支付通道的全节点自行设定，可设定的范围为0.01%至0.1%，且单笔支付手续费最少为1分，链下交易费全部用于奖励运营链下支付通道的全节点，链下交易通道由全节点运营；  
...
* 链上手续费：0.1%，必须，付方支付；
* 链下手续费：由开通链下支付通道的全节点自行设定，0.01%-0.1%，收方支付，链下支付通道清算；
* 手续费分成：链上手续费的99%由铸块的全节点获得，1%由国储会权威节点获得，链下手续费全部由运营链下支付通过的全节点获得；
* 链下交易上链的，除全节点获得的手续费外，不用再支付链上交易费，例：小李支付1000元五民币给小习，使用的是2B全节点开通的链下支付通道，费率0.1%，那么小习收到999元，2B全节点收到1元，2B关闭通道上链的，那999元不用支付链上交易费，获得的1元需要支付链上交易费；
### 6.1.5.钱包/wallet
