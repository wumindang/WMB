...
## 3.2.融资与空投发行
### 3.2.1.融资发行
* 使用兼容以太坊区的Arbitrum发行1,443,497,378.00元数字五民币，并公开销售，销售价格为每1.00元数字五民币0.01USDT，最大销售额44,349,737.8USDT（4434.97万USDT），暂以USDT计价，实际计价币种以发行为准；
   |           资金用途                       |     占比    |  预算金额（USDT）  |
   |:---------------------------------------:|:-----------:|:---------------:|
   ...
   |市场推广与社区建设                         |   22.55%    |    1000.00万     |
   |交易所及流动性相关费用                     |   22.55%     |    1000.00万     |
   |法律、管理及其他费用                       |   11.27%     |    500.00万     |
   |五民党安全基金                            |   27.05%    |    1200.00万   | 

* 购买融资发行的数字五民币的用户，且购买后即锁仓90天，满90天后可逐步解锁，解锁及奖励规则如下：
   |   锁仓时间    |     锁仓状态     |    奖励资格   |
   |:------------:|:--------------:|:------------:|
   |未满90天的     |  锁死           |     无       |
   |满90天的      |  可解锁50%的仓位  |     无       |
