...
* 全节点数量不限，部署运行全节点软件的即是全节点，部署运行全节点时需要锁仓10000.00元数字五民币以上；
...
## 3.6.轻节点发行
* 轻节点发行是指使用联邦公民身份识别码完成轻节点认证，系统发行数字五民币用于奖励认证的轻节点，可获得认证奖励的轻节点总量为1,443,497,378个；轻节点发行总量未超过144,349,737,800.00元的，每个认证的轻节点奖励9999.00元，轻节点发行总量超过144,349,737,800.00元后，每个认证的轻节点奖励999.00元；  
...
## 4.2.链下交易费
* 数字五民币的链下交易手续费由开通运营链下支付通道的节点自行设定，可设定的范围为1‰至30‰，链下交易费全部用于奖励运营链下支付通道的节点；  
