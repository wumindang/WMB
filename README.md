...
* 中国的历史至暴秦以来，一直在不断的加强中央集权，中共建政后，极左的共产主义在集权的皇权专制社会找到了最理想的土壤，两者臭味相投、狼狈为奸，将集权与暴政推向了一个史无前例的高潮；
* 如今在信息时代、数据时代全面来临的情况下，中共不但不反思过往的错误，反而在集权暴政这条路上狂奔不止，丝毫没有刹车减速的意向，随着长城防火墙的不断升级和AI封锁技术的应用，中国变得越加的封闭，中共及其附属的权贵阶层越发的想要控制社会的角角落落；
...
* 轻节点：轻节点分为公民轻节点和访客轻节点，公民轻节点（WuminApp）经过公民身份认证后拥有投票权，访客轻节点（WuminBi）没有投票权。   
...
* 国储会权威节点使用国储会权威节点软件，国储会权威节点有1个钱包地址。
### 2.3.2.省储会  
* 除43个初始省储会权威节点外，后新增省储会的，每新增1个省储会即增加1个权威节点，新增的权威节点可被删除；  
* 每个省储会权威节点拥有1个多签名地址，该多签名地址拥有9个管理员，9个管理员分别是该省储备委员会的9个委员；
...
* 国储会权威节点软件能发起投票、发行和销毁数字五民币、增加/减少新省储会和新省储行、改变超级节点状态等流程；  
* 省储会权威节点能发起投票、发行和销毁数字五民币等流程，省储会发起发行数字五民币的，需经由国储会和省储会的投票通过；
...
* 每个省储行权益节点的多签名地址有19个管理员，19个管理员分别是该省储行董事会的19个董事，对节点的所有操作需超过13个管理员的授权；
* 每个省储行权益节点拥有1个质押钱包地址，该钱包仅用于质押省储行创立发行的数字五民币和接受捐赠的数字五民币,该钱包只能接收数字五民币，不能进行其他任何操作；
* 每个省储行权益节点拥有1个储蓄钱包地址，该钱包地址用于省储行日常业务及接收质押利息等；
* 权益节点能发起仅限于权益节点之间投票的投票，对于权益节点的投票，有超过65%的权益节点投同意票的即通过，反之则否决。  
## 2.5.全节点    
...
* 我们深知一个人在社会中享有若干权益的同时，同样应尽若干义务，尽了若干义务的，亦应享受若干权益，因此，创世发行寓意每一个中国人支付1.00元，以支持五民主义和去中心化的民主运动，待到去中心化的民主运动成功后，自由民主之光亦会照耀到每一个中国人。  
## 3.2.融资与空投发行
### 3.2.1.融资发行
* 使用兼容以太坊区的Arbitrum发行1,443,497,378.00元数字五民币，并公开销售，销售价格为每1.00元数字五民币0.01USDT，最大销售额14,434,973.78USDT（1443.49万USDT），暂以USDT计价，实际计价币种以发行为准；
   |           资金用途                       |     占比    |  预算金额（USDT）  |
   |:---------------------------------------:|:-----------:|:---------------:|
...
* 购买融资发行的数字五民币的用户，将获得融资发行奖励，由五民币金融区块链系统空投发行奖励，用户将持有的融资发行的五民币，兑换为五民币区块链系统原生五民币之后，系统即发行对应数量的原生五民币奖励该用户;
   |     类型       |     来源     |       奖励        |
   |:--------------:|:-----------:|:-----------------:|
   |  以太坊/五民币   |   融资发行   |   每1元奖励2元      |
   |  原生五民币      |   系统发行   |     无奖励         |
   |  其他区块链      |      -      |     无奖励         |
* 在五民币金融区块链系统上线后，开通跨链桥，方便用户自由兑换数字五民币，原生数字五民币与以太坊版的数字五民币的兑换汇率为1:1兑换，即1.00元以太坊版的数字五民币兑换1.00元五民币金融区块链系统的原生数字五民币；
### 3.2.2.空投发行
...
* 空投发行最大总量=融资发行量x奖励，奖励为1:2，如下所示：
   |       发行目标区块链    |           发行量         |      简述      |
   |:--------------------:|:------------------------:|:-------------:|
   |Arbitrum/以太坊L2链            |   1,443,497,378.00元     |   14.43亿元    | 
   |五民币金融区块链         |   2,886,994,756.00元     |   28.86亿元    |
   |融资及空投发行量总计          |   4,330,492,134.00元     |   43.30亿元     |
* 在所有满足条件的奖励均发放完成后，智能合约中剩余未空投的数字五民币将被平均分配给所有省储行权益节点，空投到权益节点的质押钱包地址，且用于奖励空投的智能合约将同步销毁，如无法平均分配的，在取得最大平均值后，多于的部分分配给岭南省省储行质押钱包地址。
## 3.3.省储行创立发行
...
## 3.6.轻节点发行
* 轻节点发行是指使用联邦公民身份识别码完成轻节点认证，系统发行数字五民币用于奖励认证的轻节点，可获得认证奖励的轻节点总量为1,443,497,378个；轻节点发行总量未超过144,349,737,800.00元的，每个认证的轻节点奖励9999.00元，轻节点发行总量超过144,349,737,800.00元后，每个认证的轻节点奖励999.00元，从第14,436,418个认证者开始即奖励999.00元；  
...
* 轻节点发行的主要目的是要让更多的公民参与去中心化的民主运动，早日推翻共产党的邪恶统治，让更多的公民加入网络治理，以提高系统安全性，通过轻节点发行，使每个公民都有公平获益的机会，并促使更多的公民学习《公民素质教育》题库，以提供公民的认知水平;公民素质教育题库由当下各个领域优秀的学者、专家、博主和知名民运人士制作视频内容，供公民学习观看。  
## 3.7.决议发行
...
# 4.费用及利息
## 4.1.链上交易费
* 数字五民币的链上交易费由基础链上交易费+动态链上交易费组成，基础链上交易费为5‰，基础链上交易费为必须收取的交易费，动态链上交易费为0至50‰，由系统根据网络拥堵情况实时计算；  
...
## 4.2.链下交易费
* 数字五民币的链下交易手续费由开通运营链下支付通道的节点自行设定，可设定的范围为1‰至30‰，链下交易费全部用于奖励运营链下支付通道的节点，链下交易通道通常由全节点运营；  
...
路径	描述
WMB/	项目根目录
├── .gitignore	Git忽略文件，指定不提交的文件或目录
├── Cargo.toml	Rust项目配置文件，定义依赖和元信息
├── README.md	项目说明文档，通常包含使用指南和简介
├── mobile/	手机端轻节点软件（支持 iOS 和 Android）
│   ├── wuminapp/	公民轻节点应用目录
│   │   ├── pubspec.yaml	Flutter配置文件，定义依赖和应用信息
│   │   └── lib/	Flutter源码目录
│   │       └── main.dart	公民轻节点主程序入口
│   └── wuminbi/	访客轻节点应用目录
│       ├── pubspec.yaml	Flutter配置文件，定义依赖和应用信息
│       └── lib/	Flutter源码目录
│           └── main.dart	访客轻节点主程序入口
├── desktop/	桌面端节点软件（支持 macOS、Linux、Windows）
│   ├── super_node/	超级节点软件目录
│   │   ├── Cargo.toml	超级节点配置文件
│   │   └── src/	超级节点源码目录
│   │       └── main.rs	超级节点主程序入口
│   ├── national_authority_node/	国储会权威节点软件目录
│   │   ├── Cargo.toml	国储会权威节点配置文件
│   │   └── src/	国储会权威节点源码目录
│   │       └── main.rs	国储会权威节点主程序入口
│   ├── prov_authority_node/	省储会权威节点软件目录
│   │   ├── Cargo.toml	省储会权威节点配置文件
│   │   └── src/	省储会权威节点源码目录
│   │       └── main.rs	省储会权威节点主程序入口
│   ├── prov_reserve_node/	省储行权益节点软件目录
│   │   ├── Cargo.toml	省储行权益节点配置文件
│   │   └── src/	省储行权益节点源码目录
│   │       └── main.rs	省储行权益节点主程序入口
│   ├── full_node/	全节点软件目录
│   │   ├── Cargo.toml	全节点配置文件
│   │   └── src/	全节点源码目录
│   │       └── main.rs	全节点主程序入口
├── core/	核心库目录，包含区块链基础功能模块
│   ├── blockchain/	区块链模块，管理区块和交易
│   │   ├── block.rs	区块定义和操作
│   │   ├── transaction.rs	交易定义和操作
│   │   └── mod.rs	区块链模块导出
│   ├── consensus/	共识机制模块
│   │   ├── pow.rs	PoW（工作量证明）实现
│   │   ├── pos.rs	PoS（权益证明）实现
│   │   └── mod.rs	共识模块导出
│   ├── crypto/	加密模块，提供哈希和签名功能
│   │   ├── hash.rs	哈希函数实现
│   │   ├── signature.rs	签名和验证功能
│   │   └── mod.rs	加密模块导出
│   ├── network/	网络模块，处理节点间通信
│   │   ├── p2p.rs	P2P网络实现
│   │   └── mod.rs	网络模块导出
│   ├── nodes/	节点模块，定义和管理各种节点类型
│   │   ├── node_types.rs	节点类型枚举定义（当前未使用）
│   │   └── mod.rs	节点模块导出
│   ├── state/	状态模块，管理账户和链上状态
│   │   ├── account.rs	账户状态定义和操作
│   │   └── mod.rs	状态模块导出
│   ├── wallet/	钱包模块，管理地址和密钥
│   │   ├── address.rs	钱包地址生成和管理
│   │   └── mod.rs	钱包模块导出
│   ├── config/	配置模块，管理系统设置
│   │   ├── setting.rs	配置定义和操作
│   │   └── mod.rs	配置模块导出
│   ├── storage/	存储模块，管理数据持久化
│   │   ├── database.rs	数据库操作实现
│   │   └── mod.rs	存储模块导出
│   ├── events/	事件模块，处理链上事件
│   │   ├── events_handle.rs	事件处理逻辑
│   │   └── mod.rs	事件模块导出
│   ├── permission/	权限模块，控制访问和操作权限
│   │   ├── permission_control.rs	权限控制实现
│   │   └── mod.rs	权限模块导出
│   └── mod.rs	核心库模块导出
