...
## 1.3.发行量概览
   |    发行类型      |            发行金额/简述            |         发行方       |          备注             |
   |:---------------:|:---------------------------------:|:-------------------:|:------------------------:|
   |   创世发行       |   1,443,497,378.00元 = 14.43亿     |        国储会        | 国储会持有               |
   |   省储行创立发行  |   144,349,737,800.00元 = 1443.49亿  |       省储行        | 质押钱包永久质押         |
   |   省储行质押发行  |   36,809,183,139.00元 = 368.09亿    |   质押发行智能合约    | 质押发行智能合约持有      |
   |   全节点发行     |   9,999,899,000.01元 = 99.99亿      |        全节点        | 写入PoW共识              |
   |   轻节点发行     |   1,571,981,633,622.00元 = 1.57万亿  |   轻节点发行智能合约   | 公民认证智能合约持有  |
...
* 创世发行1,443,497,378.00元数字五民币（14.43亿元），创世发行量以中共第7次人口普查数据为基准，每一个中共国人发行1.00元数字五民币；
   |    中共第7次人口普查数据   |          创世发行量       |    国储会五民币交易钱包地址      |           国储会USDT钱包地址               |
   |:-----------------------:|:-----------------------:|:---------------------------------------:|:---------------------------------------:|
   |    1,443,497,378人      |   1,443,497,378.00元     |   xxxxxx                                |   0x5f6ffe832d1af30cb732959bcfca9725e82e32b9 |
