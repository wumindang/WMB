...
# 1.总则
## 1.1.目的与背景
* 基于区块链技术用于推动由五民党发起的<<去中心化的民主运动>>的新型法定货币系统，创立五民币区块链，推广去中心化的民主运动，以建立自由民主的中华民族联邦共和国；
* 五民币区块链是一个不受任何机构掌控的法定数字货币系统，一个所有人都能自由使用的法定数字货币系统，一个所有中华民族联邦共和国公民都能参与投票治理的法定数字货币系统；
* 五民币区块链是一个结合公权、金融、市场和区块链的综合系统，将民主化运动和建立联邦共和国与去中心化的金融系统深度绑定，以此构建一个具有公信、安全、开放、透明、高效的无国界区块链系统。
...
* 超级节点生成创世区块的同时生成国储会权威节点和所有初始省储会权威节点、初始省储行权益节点及其管理员；
...
* 国储会权威节点软件能发起投票、发行和销毁数字五民币等流程，并承担数据归档，国储会节点发起发行、销毁流程的，需权威节点间投票,且公民轻节点可投票驳回。
## 2.4.省储会权威节点  
...
* 使用省储行权益点软件，采用T≥6的门限签名，签名通过则生效，反之则否决，并承担数据归档；
...
* 一个人在社会中享有若干权益的同时，同样应尽若干义务，尽了若干义务的，亦应享受若干权益，创世发行寓意每一个中共国人支付1.00元，以支持五民主义和去中心化的民主运动。  
## 3.2.融资发行
...
****
# 6.技术开发
* 后端主要语言Rust，前期采用Substrate框架，智能合约lnk并兼容EVM以太坊，桌面前端用Tauri框架，手机前端用Flutter框架；
* 采用模块化开发，开发初期就要做好为后期去框架的准备，符合长期技术演进，为今后重构中国的政府、金融、通信等领域的应用预留扩展。
## 6.1.核心模块/core
### 6.1.1.区块链/block
